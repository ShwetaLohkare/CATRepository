...
And I assign 4 to variable "exponent"
And I assign 1 to variable "counter"
And I assign "this sentence goes on " to variable "sentence"
...
If I verify number $base is less than or equal to 10
	And I verify number $exponent is less than or equal to 10
 	...
 	While I verify number $counter is less than or equal to $exponent
		When I multiply variable "result" by $base
      	And I assign variable "var" by combining  $sentence " and on"
 	   And I increase variable "counter" by 1
	EndWhile
    
Then I echo $base "raised by" $exponent "is equal to " $result

Else I echo "Base or exponent should be less than 10"
Endif